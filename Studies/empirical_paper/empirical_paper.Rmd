...
mod2 <- lm(behavior_ave ~ burnout + job_sat + sent_vader + n_words + n_first_person + n_first_personp + n_second_personp  + n_third_person, data = reasons_for_scaled)
mod2 %>% summary() 
...
mod2 <- lm(behavior_ave ~ job_sat + burnout + Topic1 + Topic2 + Topic3 + sent_vader + n_words + n_first_person + n_first_personp + n_second_personp + n_third_person, data = against_scaled)
summary(mod2) 
