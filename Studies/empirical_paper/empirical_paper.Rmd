...
mlm_data <- reasons_for_topic_props %>% 
  mutate(behavior_centered = scale(behavior_ave), 
        person = as.factor(participant_id))  


# scale variables 

#unconditional means model
model0_fit <- lmer(formula = behavior_centered ~ 1 + (1|person), 
              data= mlm_data,
