...
# identify best k
against_ntopics <- searchK(against_out$documents, against_out$vocab, K = c(2, 3, 4, 5), data = meta)
...
plot(against_est_three_1, covariate = "Att_Ave", model = against_fit_three,
     method = "continuous", xlab = "Attitude", topics = c(2), 
     main = "Attitude by Topic 2 \n in Reasons Against")  
