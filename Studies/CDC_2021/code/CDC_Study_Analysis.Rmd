...
plot.STM(fit_three, type = "summary") 
...
# expected proportion of topics in all reasons for data 
plot.STM(fit_four, type = "summary") 
...
est1 <- estimateEffect(1:3 ~ Att_Ave, stmobj = fit_three, metadata = out$meta)   
## Estimate the effect on all three topics and return the point
## estimates in a tidy data frame
effect <- extract.estimateEffect(est1, "Att_Ave", model = fit_three, method = "pointestimate") 
