...
processed <- textProcessor(twitter_data$text, metadata = twitter_data) 
...
# fit statistics for k = 2 to 7 topic estimations  
plot(ntopics) # based on coherence, a two to four topic solution looks best 
